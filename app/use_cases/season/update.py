...
from app.domain.season.entity import (Season, SeasonInDB, SeasonInUpdate,
                                      SeasonInUpdateTime)
...
class UpdateSeasonRequestObject(request_object.ValidRequestObject):
    def __init__(self, id: str,
                 obj_in: SeasonInUpdate) -> None:
        self.id = id
        self.obj_in = obj_in

    @classmethod
    def builder(cls, id: str,
                payload: Optional[SeasonInUpdate] = None
...
class UpdateSeasonUseCase(use_case.UseCase):
    ...
    def process_request(self, req_object: UpdateSeasonRequestObject):
        ...
        self.season_repository.update(id=season.id, data=SeasonInUpdateTime(
