...
class CreateDocumentRequestObject(request_object.ValidRequestObject):
    ...
    @classmethod
    def builder(cls, current_admin: AdminModel, payload: Optional[DocumentInCreate] = None) -> request_object.RequestObject:
    ...
    def process_request(self, req_object: CreateDocumentRequestObject):
        ...
        self.background_tasks.add_task(self.audit_log_repository.create, AuditLogInDB(
            ...
            description=json.dumps(
                req_object.document_in.model_dump(exclude_none=True), default=str)
        ))
