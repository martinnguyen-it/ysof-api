...
class ListSubjectsShortRequestObject(request_object.ValidRequestObject):
    def __init__(
        self,
...
class ListSubjectsShortUseCase(use_case.UseCase):
    def __init__(self, subject_repository: SubjectRepository = Depends(SubjectRepository)):
        self.subject_repository = subject_repository

    def process_request(self, req_object: ListSubjectsShortRequestObject):
