...
from app.interfaces.api_v1 import (
    admin,
    admin_auth,
    student_admin,
    upload,
...
api_router.include_router(admin_auth.router, prefix="/admin/auth", tags=["Auth Admin"])
api_router.include_router(student_auth.router, prefix="/student/auth", tags=["Auth Student"])
...
api_router.include_router(student_admin.router, prefix="/admin/students", tags=["Students by admin"])
