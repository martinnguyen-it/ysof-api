...
from app.use_cases.admin_auth.update_password import UpdateAdminPasswordRequestObject, UpdateAdminPasswordUseCase
...
def change_password(
    ...
    update_admin_password_use_case: UpdateAdminPasswordUseCase = Depends(UpdateAdminPasswordUseCase),
    current_admin: AdminModel = Depends(get_current_admin),
):
    req_object = UpdateAdminPasswordRequestObject.builder(payload=payload, current_admin=current_admin)
