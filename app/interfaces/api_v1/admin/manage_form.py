...
from app.domain.manage_form.entity import CommonResponse, CommonUpdate, SubjectRegistrationUpdate
...
@router.get("/subject-registration", response_model=CommonResponse)
@response_decorator()
