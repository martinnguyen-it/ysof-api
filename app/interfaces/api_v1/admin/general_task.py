...
def create_general_task(
    payload: GeneralTaskInCreate = Body(..., title="GeneralTask In Create payload"),
    create_general_task_use_case: CreateGeneralTaskUseCase = Depends(CreateGeneralTaskUseCase),
...
def get_list_general_tasks(
    ...
    req_object = ListGeneralTasksRequestObject.builder(
...
def update_general_task(
    ...
    payload: GeneralTaskInUpdate = Body(..., title="GeneralTask updated payload"),
    update_general_task_use_case: UpdateGeneralTaskUseCase = Depends(UpdateGeneralTaskUseCase),
    current_admin: AdminModel = Depends(get_current_active_admin),
):
...
def delete_general_task(
    id: str = Path(..., title="GeneralTask Id"),
    delete_general_task_use_case: DeleteGeneralTaskUseCase = Depends(DeleteGeneralTaskUseCase),
    current_admin: AdminModel = Depends(get_current_active_admin),
):
    req_object = DeleteGeneralTaskRequestObject.builder(id=id, current_admin=current_admin)
